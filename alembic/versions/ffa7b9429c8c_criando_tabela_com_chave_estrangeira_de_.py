...
def upgrade() -> None:
    ...
    op.alter_column('contas_a_pagar_receber', sa.Column('fornecedor_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'contas_a_pagar_receber', 'fornecedor_cliente', ['forenecedor_id'], ['id'])
