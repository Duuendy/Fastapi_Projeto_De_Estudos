...
def listar_fornecedor_cliente_by_id(id_fornecedor_cliente: int, db_connection: Session = Depends(get_db_connection)) -> FornecedorClienteResponse:
...
def cadastrar_fornecedor_cliente(fornecedor_cliente_request: FornecedorClienteRequest, db_connection: Session = Depends(get_db_connection)) -> FornecedorClienteResponse:
...
def atualizar_fornecedor_cliente(id_fornecedor_cliente: int, forncedor_cliente_request: FornecedorClienteRequest, db_connection: Session = Depends(get_db_connection)) -> FornecedorClienteResponse:
